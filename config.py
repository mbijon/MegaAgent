...
# Default to placeholder if not set (will fail on actual API calls)
api_key = os.environ.get("OPENAI_API_KEY", "sk-your_api_key_here")

# Default to GPT-5.1, can be overridden via OPENAI_MODEL environment variable
model = os.environ.get("OPENAI_MODEL", "gpt-5.1")

url = "https://api.openai.com/v1/chat/completions"

# Enable web search tool for GPT-5 models (can be disabled via environment variable)
